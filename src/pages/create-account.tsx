...
export default function CreateAccount(props: IPageProps) {
  ...
  const createAccount = (event: FormEvent<HTMLFormElement>) => {
    ...
    fetch(
      `http://party-push-backend.us-east-1.elasticbeanstalk.com/Party/add-user?username=${createAccountInfo.username}&password=${createAccountInfo.password}&phone_number=${createAccountInfo.phoneNumber}`,
      {
        method: "GET",
        headers: {
